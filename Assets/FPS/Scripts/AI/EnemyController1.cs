...
//             DebugUtility.HandleErrorIfNullFindObject<EnemyManager, EnemyController1>(m_EnemyManager, this);

//             m_ActorsManager = FindObjectOfType<ActorsManager>();
//             DebugUtility.HandleErrorIfNullFindObject<ActorsManager, EnemyController1>(m_ActorsManager, this);

//             m_EnemyManager.RegisterEnemy(this);

//             m_Health = GetComponent<Health>();
//             DebugUtility.HandleErrorIfNullGetComponent<Health, EnemyController1>(m_Health, this, gameObject);

//             m_Actor = GetComponent<Actor>();
//             DebugUtility.HandleErrorIfNullGetComponent<Actor, EnemyController1>(m_Actor, this, gameObject);

//             NavMeshAgent = GetComponent<NavMeshAgent>();
//             m_SelfColliders = GetComponentsInChildren<Collider>();

//             m_GameFlowManager = FindObjectOfType<GameFlowManager>();
//             DebugUtility.HandleErrorIfNullFindObject<GameFlowManager, EnemyController1>(m_GameFlowManager, this);
...
//             DebugUtility.HandleErrorIfNoComponentFound<DetectionModule, EnemyController1>(detectionModules.Length, this,
//                 gameObject);
//             DebugUtility.HandleWarningIfDuplicateObjects<DetectionModule, EnemyController1>(detectionModules.Length,
//                 this, gameObject);
...
//             if (damageSource && !damageSource.GetComponent<EnemyController1>())
//             {
//                 // pursue the player
...
//                 DebugUtility.HandleErrorIfNoComponentFound<WeaponController, EnemyController1>(m_Weapons.Length, this,
//                     gameObject);
...
//             DebugUtility.HandleErrorIfNullGetComponent<WeaponController, EnemyController1>(m_CurrentWeapon, this,
//                 gameObject);
